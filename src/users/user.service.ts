...
export class UserService {
  ...
  constructor() {
    ...
    this.userPermissionsRepository = AppDataSource.getRepository(UserPermissions);
  }
  ...
  async checkPermissions(name: string, taskListTitle: string): Promise<UserPermissions> {
    try {
  ...
  async givePermissions(user: User, taskList: TaskList, premissions: PermissionDto): Promise<InsertResult> {
